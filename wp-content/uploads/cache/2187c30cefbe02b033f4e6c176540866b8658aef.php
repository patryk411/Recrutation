...
<main class="main">
  ...
  <section class="main__services py-5">
      ...
      <h3 class="main__services--heading"><?php echo the_field('service_heading');; ?></h3>
                        ...
                        $serviceSection->the_post();?>
                          ...
                          <div class="main__services__content__box__single-box col-md-5 col-lg-3">
                              <div class="main__services__content__box__single-box--icon">
                                <img class="mt-3" src="<?php $pageBannerImage = get_field('service_img'); echo $pageBannerImage['url'] ?>" class="card-img-top" alt="...">
    ...
    <div class="container-fluid">
      <div class="main__about__content">
          ...
          <div class="main__about__content__text col-md-11 col-lg-7">
            ...
            <h3 class="main__about__content__text--heading col-md-12 col-lg-6 p-0"><?php echo the_field('about_heading');; ?> <span class="header-span">Podczas realizacji</span> otrzymasz od nas: </h3>

            <p class="main__about__content__text--text col-md-12 col-lg-9 p-0"><?php echo the_field('about_content');; ?> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut</p>
                    ...
                    $serviceSection = new WP_Query(array(
                      ...
                      while($serviceSection->have_posts()) {
                        ...
                        <div class="main__about__content__text__boxes__single-box col-sm-12 col-md-12">
                          ...
                          <div class="svg-box">
                              <img class="mt-3" src="<?php $aboutImage = get_field('realization_img'); echo $aboutImage['url'] ?>" class="card-img-top" alt="...">
                          </div>
