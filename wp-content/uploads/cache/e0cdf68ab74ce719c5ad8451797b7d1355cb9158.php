<main class="main">
    ...
    <section class="main__services py-5">
        ...
        <h3 class="main__services--heading"><?php var_dump(get_field('service_heading')) ?><span class="service-head">Ciebie</span> zrobić?</h3>
      ...
      <div class="container-fluid">
        <div class="main__about__content">
            ...
            <div class="main__about__content__text col-md-11 col-lg-7">
              ...
              <h3 class="main__about__content__text--heading col-md-12 col-lg-6 p-0"><span class="header-span">Podczas realizacji</span> otrzymasz od nas:</h3>
