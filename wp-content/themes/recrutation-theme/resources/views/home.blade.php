...
<main class="main">
  ...
  <section class="main__services py-5">
      ...
      <h3 class="main__services--heading">{!! the_field('service_heading'); !!}</h3>
    ...
    <div class="container-fluid">
      <div class="main__about__content">
          ...
          <div class="main__about__content__text col-md-11 col-lg-7">
            ...
            <h3 class="main__about__content__text--heading col-md-12 col-lg-6 p-0">{!! the_field('about_heading'); !!} <span class="header-span">Podczas realizacji</span> otrzymasz od nas: </h3>

            <p class="main__about__content__text--text col-md-12 col-lg-9 p-0">{!! the_field('about_content'); !!} Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut</p>
